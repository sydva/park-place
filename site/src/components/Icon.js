...
const IconComponents = {
  ...
  camera: () => (
    <svg viewBox="0 0 24 24" fill="currentColor">
      <path d="M12 15c1.66 0 2.99-1.34 2.99-3L15 9c0-1.66-1.34-3-3-3s-3 1.34-3 3v3c0 1.66 1.34 3 3 3zm5.3-3c0 3-2.54 5.1-5.3 5.1S6.7 15 6.7 12H5c0 3.41 2.72 6.23 6 6.72V21h2v-2.28c3.28-.48 6-3.3 6-6.72h-1.7z"/>
      <path d="M9 9h6v6H9z"/>
    </svg>
  )
};
